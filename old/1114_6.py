...
#以下のフォルダに格納されているファイルを識別するために変数に代入
dir_name = "cliaringfand"

#とりあえずフルパスで片っ端からファイルを取得
l = glob.glob(r'C:\\Users\\turnt\\OneDrive\\デスクトップ\\Python\\2024_python_practice\\test_py\\**\\*.csv', recursive=True)
ans_l = []
